...
import EditRegionModal from "../../../domain/settings/regions/edit/general-section/edit-region.modal"

type Props = {
  region: Region
}

const GeneralSectionMVN = ({ region }: Props) => {
...
export default GeneralSectionMVN
