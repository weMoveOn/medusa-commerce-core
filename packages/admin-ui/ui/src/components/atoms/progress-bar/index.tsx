  ...
  return (
    <div className=" flex items-center justify-between">
      <div className="w-full rounded-full bg-gray-200 dark:bg-gray-700">
        <div
          className="relative h-2.5 rounded-full bg-purple-600 text-center text-xs font-medium leading-none text-blue-100"
          style={{ width: progress }}
        >
          <div className="absolute -top-2 right-0  flex h-7 w-7 justify-center rounded-full bg-slate-50 shadow-lg">
            <div className="my-auto mx-auto h-3 w-3 rounded-full bg-purple-600"></div>
          </div>
        </div>
      </div>
