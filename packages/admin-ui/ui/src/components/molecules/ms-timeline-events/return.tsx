...
const MsReturn: React.FC<ReturnRequestedProps> = ({ event, refetch }) => {
  ...
  return {
    ...
    children:
      event.status === "requested"
        ? [
            React.createElement(React.Fragment, { key: "p" }, <p className="font-bold my-4">Return Items</p>),
