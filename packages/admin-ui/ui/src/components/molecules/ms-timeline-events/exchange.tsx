...
const MsExchange: React.FC<ExchangeProps> = ({ event, refetch }) => {
...
function getNewItems(event: ExchangeEvent) {
  return (
    <div className="gap-y-small flex flex-col">
      <span className="inter-small-regular font-bold">Added Products</span>
      <div>
...
function getReturnItems(event: ExchangeEvent) {
  return (
    <div className="gap-y-small flex flex-col">
      <span className="inter-small-regular font-bold">Removed Products</span>
      <div>
        {event.returnItems
          .filter((i) => !!i)
          .map((i: ReturnItem) => (
