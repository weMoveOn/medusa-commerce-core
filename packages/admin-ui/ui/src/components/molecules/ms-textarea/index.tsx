...
const MsTextArea = React.forwardRef<HTMLTextAreaElement, TextareaProps>(
  (
    {
      placeholder,
      label,
    ...
    return (
      <div className={className} {...containerProps}>
        ...
        <div
          className={clsx(
            "focus-within:shadow-input focus-within:border-violet-60 px-small py-xsmall bg-grey-5 border-grey-20 rounded-rounded flex w-full flex-col border h-40",
            {
