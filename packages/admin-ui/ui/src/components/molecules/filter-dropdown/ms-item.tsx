...
import  {
  CalendarComponent,
} from "../../atoms/date-picker/date-picker"
    ...
    >
      ...
      >
          ...
          <div className="flex items-center">
            ...
            >
              <span className="self-center">
                <FilterIcon className="font-thin" color="#242424" size={16} />
              </span>
            </div>
            <input
              id={filterTitle}
        ...
        <RadixCollapsible.Content className="w-full">
          ...
          {isLoading ? (
            ...
            options.map((el, i) => {
              ...
              return (
                <div
                  className={clsx(
                    "hover:bg-grey-20 my-1 flex w-full items-center rounded py-4 pl-6",
                    {
                ...
                >
                  <div
                    className={`text-grey-0 border-grey-30 rounded-base mr-2 flex h-5 w-5 justify-center border ${
                      checked[value] === true && "bg-black"
                    }`}
                  >
                    <span className="self-center">
                      {checked[value] === true && (
                        <CheckIcon size={14} className="rounded-rounded" />
                      )}
                    </span>
                  </div>
                  <input
          ...
          <button onClick={() => setChecked({})} className="mt-2">
            <span className="mt-2 pl-6 text-base text-[#1689F3]">Clear</span>
          </button>
          {hasMore && (
            <div className="flex py-2 pl-6">
              <button
